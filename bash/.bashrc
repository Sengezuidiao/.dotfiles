...
alias vim="nvim"
# 设置交叉编译工具链
#export CC=/opt/toolchain/aarch64/bin/aarch64-linux-gnu-gcc
#export CXX=/opt/toolchain/aarch64/bin/aarch64-linux-gnu-g++

# 设置库和头文件查找路径
#export CMAKE_FIND_ROOT_PATH=/opt/toolchain/aarch64
#export LD_LIBRARY_PATH=/opt/toolchain/aarch64

# 确保工具链的 bin 目录在 PATH 中
